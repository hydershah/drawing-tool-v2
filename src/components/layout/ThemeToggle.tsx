...
export function ThemeToggle() {
  ...
  return (
    ...
    >
      <Sun className="h-6 w-6 md:h-10 md:w-10 rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0" />
      <svg className="absolute h-6 w-6 md:h-10 md:w-10 rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 66.39 67.63" fill="currentColor">
