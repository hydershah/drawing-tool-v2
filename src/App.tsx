    ...
    <>
      ...
      <div className="fixed top-2 right-2 md:top-4 md:right-4 flex flex-wrap gap-1.5 md:gap-4 z-[9999] max-w-[calc(100vw-80px)] md:max-w-none justify-end">
        ...
        <NavButton
          ...
          icon={
            <svg className="w-10 h-10 md:w-12 md:h-12" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 66.39 67.63" fill="currentColor">
        ...
        {isAdmin && (
          <>
            <NavButton
              ...
              icon={<List className="w-10 h-10 md:w-12 md:h-12" />}
            ...
            <NavButton
              ...
              isActive={false}
              onClick={logout}
              icon={<LogOut className="w-10 h-10 md:w-12 md:h-12" />}
              tooltip="Logout"
              variant="destructive"
            />
          </>
